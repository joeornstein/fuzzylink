...
- The `model` argument specifies which OpenAI language model to prompt. It defaults to 'gpt-3.5-turbo-instruct', but for more difficult problems you can try 'gpt-4' or 'gpt-4-turbo-preview'. Note that this will typically increase accuracy at the expsense of cost and runtime (see "A Note on Cost" below).
